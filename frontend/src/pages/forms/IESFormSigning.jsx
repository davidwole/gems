...
export default function IESFormSigning() {
  ...
  const fetchForm = async () => {
    const response = await fetch(`${API_URL}/ies-forms/${userId}`, {
      headers: {
          ...
          <tbody>
            ...
            <tr className="official_sign">
              <td colSpan={7}>
                ...
                <div className="flex eligibity_margin margin_block">
                  <div className="margin_right_15">
                    <label>
                      <strong>Determining Official’s Signature:</strong>
                    </label>

                    <Signature
                      onSave={handleSignatureSave}
                      name="determiningSignature"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      type="date"
                      name="determiningSignatureDate"
                      value={signatures.determiningSignatureDate}
                ...
                <div className="flex eligibity_margin margin_block">
                  <div className="margin_right_15">
                    <label>
                      <strong>Confirming Official’s Signature:</strong>
                    </label>

                    <Signature
                      name="confirmingSignature"
                      onSave={handleSignatureSave}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      type="date"
                      name="confirmingSignatureDate"
                      value={signatures.confirmingSignatureDate}
                      onChange={handleDateChange}
                    />
                  </div>
                </div>
                <div className="flex eligibity_margin margin_block">
                  <div className="margin_right_15">
                    <label>
                      <strong>Follow Up Official’s Signature:</strong>
                    </label>
                    <Signature
                  ...
                  <div>
                    ...
                    <input
                      type="date"
                      name="followUpSignatureDate"
                      value={signatures.followUpSignatureDate}
                      onChange={handleDateChange}
                    />
                  </div>
                </div>
                <button className="approve-button">Submit</button>
              </td>
            </tr>
          </tbody>
        </table>
