      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="addressbar">
          ...
          <div>
            <input
              ...
              onChange={(e) =>
                handleAuthorizedPersonAddressChange(1, "street", e.target.value)
              }
            />
            <label>Number Street</label>
          </div>
          ...
          <div>
            <input
              ...
              onChange={(e) =>
                handleAuthorizedPersonAddressChange(1, "state", e.target.value)
              }
            />
            <label>State</label>
          </div>
        ...
        <div className="flex input_spacer_med">
          ...
          <input
            ...
            onChange={(e) =>
              handleAuthorizedPersonChange(1, "alternatePhone", e.target.value)
            }
          />
        </div>
        <div className="flex input_spacer_med">
        ...
        <div className="addressbar">
          ...
          <div>
            <input
              ...
              onChange={(e) =>
                handleAuthorizedPersonAddressChange(2, "street", e.target.value)
              }
            />
            <label>Number Street</label>
          </div>
          ...
          <div>
            <input
              ...
              onChange={(e) =>
                handleAuthorizedPersonAddressChange(2, "state", e.target.value)
              }
            />
            <label>State</label>
          </div>
        ...
        <div className="flex input_spacer_med">
          ...
          <input
            ...
            onChange={(e) =>
              handleAuthorizedPersonChange(2, "alternatePhone", e.target.value)
            }
          />
        </div>
        <div className="flex input_spacer_med">
        ...
        <div className="school_info">
          ...
          <div className="flex input_spacer_med">
            ...
            <input
              ...
              onChange={(e) =>
                handleNestedChange("schoolInfo", "teacherName", e.target.value)
              }
            />
          </div>
        </div>
        ...
        <div className="emergency_medical_authroization">
          ...
          <p>
            ...
            informed of changes in telephone numbers, etc., where I (we) can be
            reached.
          </p>
          ...
          <div className="addressbar">
            ...
            <div>
              <input
                ...
                onChange={(e) =>
                  handleAddressChange("doctorAddress", "street", e.target.value)
                }
              />
              <label>Number Street</label>
            </div>
            ...
            <div>
              <input
                ...
                onChange={(e) =>
                  handleAddressChange("doctorAddress", "state", e.target.value)
                }
              />
              <label>State</label>
            </div>
