      ...
      <form onSubmit={handleSubmit}>
        <table>
          <tbody>
            ...
            {/* Household Members List - Connect to state */}
            <tr>
              <td colSpan={3} className="col-40">
                ...
                <ul className="ies_custom_form">
                  ...
                  <li>
                    <div className="flex">
                      ...
                      <input
                        type="text"
                        name="houseHoldMemberTwo.workEarningsFreq"
                        value={formData.houseHoldMemberTwo.workEarningsFreq}
                        onChange={handleChange}
                      />
                    </div>
                  </li>
                  {/* Continue for remaining household members */}
                </ul>
              </td>
