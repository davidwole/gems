...
export default function IESFormUnfilled() {
            ...
            <tbody>
              ...
              <tr>
                ...
                <td rowSpan="2" className="col-25">
                  ...
                  children only. All the above, or SSI or Medicaid case number
                  for Adults. <strong>Note:</strong> Do not use EBT numbers.
                  Write case number and proceed to Part III.
                </td>
                <td colSpan="5" className="col-30">
                  <strong>
                    Children in Head Start, foster care and children who meet
                    the definition of migrant, runaway, or homeless are eligible
                    for free meals. Check (✓) all that apply.{" "}
              ...
              <tr>
                <td colSpan={7} className="parts-header">
                  PART II: Report income for ALL Household Members (Skip this
                  step if participant is categorically eligible as documented in
                  Part I.) Are you unsure what income to include here? Flip the
                  page and review the charts titled "Sources of Income" for more
                  information.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td colSpan={7}>
                  ...
                  . List all household members even if they do not receive
                  income. Also, list the adult participant if he/she did not
                  meet eligibility in Part I. For each Household Member listed,
                  if they do receive income, report total gross income (before
                  taxes) for each source in whole dollars (no cents) only along
                  the frequency i.e., twice a month, weekly, etc. If they do not
                  receive income from any source, write '0'. If you enter "0" or
                  leave any field blank you are certifying (promising) there is
                  no income to report.
                </td>
              </tr>
              ...
              <tr>
                <td colSpan={7}>
                  C. Total Household Members (Adults and Children) listed in
                  Part I and Part II
                  <input
                    type="number"
              ...
              <tr>
                <td colSpan={7}>
                  <div>
                    ...
                    income), the adult completing the form must also list the
                    last four digits of his or her Social Security Number or
                    check the "I don't have a Social Security Number" box below.
                    (See Privacy Act Statement on next page).{" "}
                    <span className="red-text">
                      Failure to complete this section, if income is listed,
                      will result in the denial of free or reduced eligibility.
                    </span>
                  </div>
              ...
              <tr>
                <td colSpan={7} className="enrollment_hours">
                  ...
                  <div>
                    My child is normally in attendance at the facility between
                    the hours of{" "}
                    <span>
                      <input
                        type="text"
              ...
              <tr>
                <td colSpan={7} className="enrollment_info">
                  ...
                  <div>
                    <i>
                      I certify that all information on this form is true and
                      that all income is reported. I understand that the center
                      or day care home will get Federal funds based on the
                      information I give. I understand that CACFP officials may
                      verify the information. I understand that if I
                      purposefully give false information, the participant
                      receiving meals may lose the meal benefits, and I may be
                      prosecuted. This signature also acknowledges that the
                      child(ren) or adult listed on the form in Part I are
                      enrolled for care.{" "}
                      <span className="red-text">
                        If not completed fully and signed, the participant will
                        be placed in the Paid category.
                      </span>
                    </i>
                  </div>
