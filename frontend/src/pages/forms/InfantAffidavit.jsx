  ...
  return (
    <div className="infant_affidavit_container">
      <form onSubmit={handleSubmit}>
        ...
        <p>
          According to USDA regulations, as an institution participating in the
          Child and Adult Care Food Program must provide meals to all infants
          enrolled for care in the center/facility.
        </p>

        <div>
          <label htmlFor="formulaBrand">
            Center/Provider will provide the following milk-based iron-fortified
            formula:{" "}
          </label>
          <input
            type="text"
          ...
          <div className="row">
            ...
            <div className="checkbox-item">
              <input
                ...
                onChange={handleCheckboxChange}
              />
              <label htmlFor="protein">Meat/Fish/Poultry/Eggs/Beans/Peas</label>
            </div>
          </div>
        ...
        <p>
          ...
          approved milk-based or soy-based iron-fortified formula be provided to
          their infant or any parent who provides any formula other than USDA
          approved milk-based or soy-based iron-fortified formula for their
          infant must provide a doctor's note indicating the required use of the
          formula. If a parent elects to have the center or day care home
          provider supply meals to their infant, the infant will be fed
          according to its individual feeding plan that is provided by the
