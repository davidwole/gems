...
exports.createEnrollmentForm = async (req, res) => {
  try {
    ...
    const newForm = new EnrollmentForm(req.body);
...
exports.updateEnrollmentForm = async (req, res) => {
  ...
  try {
    ...
    const updatedForm = await EnrollmentForm.findByIdAndUpdate(id, req.body, {
      new: true,
      runValidators: true,
    });
...
exports.updateFormStatus = async (req, res) => {
  ...
  try {
    const form = await EnrollmentForm.findByIdAndUpdate(id, req.body);
